...
public class UI : MonoBehaviour
{
    ...
    public void clickQuestBtn()
    {
        ...
        if (QM.GetComponent<QuestManager>().selected_num <=3)
        {
            ...
            GameManager.gameManager_Instance.difficulty = GameManager.gameManager_Instance.quest_list[i].a;
            GameManager.gameManager_Instance.quest_reward = GameManager.gameManager_Instance.quest_list[i].b;
